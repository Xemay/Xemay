...
const faq: FaqItem[] = [
  ...
  },
  {
    ...
    answer: 'Всё нормально. Начнём с задачи и ограничений, затем оформим ТЗ и состав работ.',
  },
  {
    id: 3,
    question: 'Что делать, если нет структуры и текстов?',
    answer: 'Определим, какие материалы уже есть и что нужно подготовить. Написание текстов для сайта входит в стоимость.',
  },
  {
    id: 4,
    question: 'Сколько правок входит?',
    answer: 'Правки в согласованной структуре и дизайне входят в стоимость. Новые страницы, функции и изменение логики оцениваются отдельно.',
  },
  {
    id: 5,
