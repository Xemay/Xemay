  ...
  <section class="hero" aria-labelledby="hero-title">
    ...
    <div class="hero__inner page-shell">
      <div class="hero__content">
        ...
        <p class="hero__lead">
            Разрабатываю сайты и Telegram-ботов для экспертов и бизнеса.
        </p>
...
.hero {
  position: relative;
  display: flex;
  min-height: min(896px, calc(100dvh - var(--header-height)));
  align-items: center;
  overflow: hidden;
  isolation: isolate;
  background: #050506;
...
.hero__glow {
  ...
  inset: 0;
  background:
    radial-gradient(circle at 50% 50%, rgb(51 112 255 / 0.1), transparent 42%),
    linear-gradient(90deg, rgb(5 5 6 / 0.42), rgb(5 5 6 / 0.08) 50%, rgb(5 5 6 / 0.42));
  pointer-events: none;
}
